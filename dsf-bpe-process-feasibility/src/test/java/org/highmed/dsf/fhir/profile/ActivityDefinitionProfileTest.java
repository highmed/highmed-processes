...
public class ActivityDefinitionProfileTest
{
	...
	public void testComputeFeasibilityValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-computeFeasibility.xml"));
	...
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-executeFeasibility.xml"));
	...
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-requestFeasibility.xml"));
