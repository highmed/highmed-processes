...
{
	String PROCESS_NAME_COMPUTE_FEASIBILITY = "computeFeasibility";
	String PROCESS_NAME_EXECUTE_FEASIBILITY = "executeFeasibility";
	String PROCESS_NAME_REQUEST_FEASIBILITY = "requestFeasibility";

	String PROCESS_NAME_FULL_COMPUTE_FEASIBILITY = "highmedorg_" + PROCESS_NAME_COMPUTE_FEASIBILITY;
	String PROCESS_NAME_FULL_EXECUTE_FEASIBILITY = "highmedorg_" + PROCESS_NAME_EXECUTE_FEASIBILITY;
	String PROCESS_NAME_FULL_REQUEST_FEASIBILITY = "highmedorg_" + PROCESS_NAME_REQUEST_FEASIBILITY;
	...
	String PROFILE_HIGHMED_TASK_REQUEST_FEASIBILITY_AND_LATEST_VERSION = PROFILE_HIGHMED_TASK_REQUEST_FEASIBILITY + "|"
			+ VERSION;
	String PROFILE_HIGHMED_TASK_REQUEST_FEASIBILITY_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_REQUEST_FEASIBILITY + "/";
	...
	String PROFILE_HIGHMED_TASK_EXECUTE_FEASIBILITY_AND_LATEST_VERSION = PROFILE_HIGHMED_TASK_EXECUTE_FEASIBILITY + "|"
			+ VERSION;
	String PROFILE_HIGHMED_TASK_EXECUTE_FEASIBILITY_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_EXECUTE_FEASIBILITY + "/";
	...
	String PROFILE_HIGHMED_TASK_COMPUTE_FEASIBILITY_AND_LATEST_VERSION = PROFILE_HIGHMED_TASK_COMPUTE_FEASIBILITY + "|"
			+ VERSION;
	String PROFILE_HIGHMED_TASK_COMPUTE_FEASIBILITY_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_COMPUTE_FEASIBILITY + "/";
