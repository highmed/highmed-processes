...
public interface ConstantsPing
{
	...
	String PROCESS_FULL_NAME_PING_AUTOSTART = "highmedorg_" + PROCESS_NAME_PING_AUTOSTART;
	String PROCESS_FULL_NAME_PING = "highmedorg_" + PROCESS_NAME_PING;
	String PROCESS_FULL_NAME_PONG = "highmedorg_" + PROCESS_NAME_PONG;
