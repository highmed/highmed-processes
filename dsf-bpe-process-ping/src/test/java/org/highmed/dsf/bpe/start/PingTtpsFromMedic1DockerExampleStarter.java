...
public class PingTtpsFromMedic1DockerExampleStarter extends AbstractPingTtpsFromMedic1ExampleStarter
{
	...
	{
		new PingTtpsFromMedic1DockerExampleStarter().main(args, MEDIC_1_DOCKER_FHIR_BASE_URL);
	}
}
