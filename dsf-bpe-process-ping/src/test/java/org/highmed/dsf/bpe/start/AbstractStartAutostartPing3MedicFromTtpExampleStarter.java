...
import static org.highmed.dsf.bpe.ConstantsPing.PROFILE_HIGHMED_TASK_START_AUTOSTART_AND_LATEST_VERSION;
...
public abstract class AbstractStartAutostartPing3MedicFromTtpExampleStarter
{
	...
	{
		Task task = new Task();
		task.getMeta().addProfile(PROFILE_HIGHMED_TASK_START_AUTOSTART_AND_LATEST_VERSION);
