...
public class ActivityDefinitionProfileTest
{
	...
	public void testDownloadAllowListValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-downloadAllowList.xml"));
	...
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-updateAllowList.xml"));
