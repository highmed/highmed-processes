...
import static org.highmed.dsf.bpe.ConstantsFeasibilityMpc.MIN_COHORT_DEFINITIONS;
import static org.highmed.dsf.bpe.ConstantsFeasibilityMpc.MIN_PARTICIPATING_MEDICS;
...
public class CheckFeasibilityMpcResources extends AbstractServiceDelegate
{
	public CheckFeasibilityMpcResources(FhirWebserviceClientProvider clientProvider, TaskHelper taskHelper,
	...
	private void checkNumberOfCohortDefinitions(List<Group> cohorts)
	{
		...
		{
			throw new RuntimeException("Number of defined cohorts is < " + MIN_COHORT_DEFINITIONS + ", got " + size);
		}
	}
}
