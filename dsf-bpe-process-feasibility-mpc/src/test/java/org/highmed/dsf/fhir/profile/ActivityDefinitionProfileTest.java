...
import static org.highmed.dsf.bpe.FeasibilityMpcProcessPluginDefinition.RELEASE_DATE;
...
public class ActivityDefinitionProfileTest
{
	...
	@Test
	public void testExecuteFeasibilityMpcMultiShareValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-executeFeasibilityMpcMultiShare.xml"));
	...
	@Test
	public void testExecuteFeasibilityMpcSingleShareValid() throws Exception
	{

		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-executeFeasibilityMpcSingleShare.xml"));
	...
	@Test
	public void testRequestFeasibilityMpcValid() throws Exception
	{
		ActivityDefinition ad = validationRule.readActivityDefinition(
				Paths.get("src/main/resources/fhir/ActivityDefinition/highmed-requestFeasibilityMpc.xml"));
