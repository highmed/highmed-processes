...
import static org.highmed.dsf.bpe.ConstantsFeasibilityMpc.PROFILE_HIGHMED_TASK_REQUEST_FEASIBILITY_MPC_AND_LATEST_VERSION;
...
public abstract class AbstractRequestFeasibilityMpcFromMedicsViaMedic1ExampleStarter
{
	...
	private ResearchStudy createResearchStudy(Group group1, Group group2)
	{
		...
		// TODO: remove tpp from research study profile
	...
	private Task createTask(ResearchStudy researchStudy)
	{
		...
		task.getMeta().addProfile(PROFILE_HIGHMED_TASK_REQUEST_FEASIBILITY_MPC_AND_LATEST_VERSION);
