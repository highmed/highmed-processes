...
{
	String PROCESS_NAME_COMPUTE_DATA_SHARING = "computeDataSharing";
	String PROCESS_NAME_EXECUTE_DATA_SHARING = "executeDataSharing";
	String PROCESS_NAME_REQUEST_DATA_SHARING = "requestDataSharing";

	String PROCESS_NAME_FULL_COMPUTE_DATA_SHARING = "highmedorg_" + PROCESS_NAME_COMPUTE_DATA_SHARING;
	String PROCESS_NAME_FULL_EXECUTE_DATA_SHARING = "highmedorg_" + PROCESS_NAME_EXECUTE_DATA_SHARING;
	String PROCESS_NAME_FULL_REQUEST_DATA_SHARING = "highmedorg_" + PROCESS_NAME_REQUEST_DATA_SHARING;
	...
	String PROFILE_HIGHMED_TASK_REQUEST_DATA_SHARING_AND_VERSION = "http://highmed.org/fhir/StructureDefinition/task-request-data-sharing"
			+ "|" + VERSION;
	String PROFILE_HIGHMED_TASK_REQUEST_DATA_SHARING_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_REQUEST_DATA_SHARING + "/";
	...
	String PROFILE_HIGHMED_TASK_EXECUTE_DATA_SHARING_AND_VERSION = "http://highmed.org/fhir/StructureDefinition/task-execute-data-sharing"
			+ "|" + VERSION;
	String PROFILE_HIGHMED_TASK_EXECUTE_DATA_SHARING_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
	...
	String PROFILE_HIGHMED_TASK_COMPUTE_DATA_SHARING_AND_VERSION = "http://highmed.org/fhir/StructureDefinition/task-compute-data-sharing"
			+ "|" + VERSION;
	String PROFILE_HIGHMED_TASK_COMPUTE_DATA_SHARING_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_COMPUTE_DATA_SHARING + "/";
