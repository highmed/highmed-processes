...
public interface ConstantsDataSharing
{
	...
	String PROFILE_HIGHMED_TASK_REQUEST_DATA_SHARING_PROCESS_URI_AND_LATEST_VERSION =
			PROFILE_HIGHMED_TASK_REQUEST_DATA_SHARING_PROCESS_URI + VERSION;
	...
	String CODESYSTEM_HIGHMED_DATA_SHARING_VALUE_SINGLE_MEDIC_RESULT = "single-medic-result";
	String CODESYSTEM_HIGHMED_DATA_SHARING_VALUE_SINGLE_MEDIC_RESULT_REFERENCE = "single-medic-result-reference";
