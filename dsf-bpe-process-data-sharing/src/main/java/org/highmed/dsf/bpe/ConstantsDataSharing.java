...
public interface ConstantsDataSharing
{
	...
	String BPMN_EXECUTION_VARIABLE_QUERY_DATA_RESULTS = "queryDataResults";
	String BPMN_EXECUTION_VARIABLE_QUERY_RBF_RESULTS = "queryRbfResults";
	String BPMN_EXECUTION_VARIABLE_FINAL_QUERY_DATA_RESULTS = "finalQueryDataResults";
	...
	String CODESYSTEM_HIGHMED_DATA_SHARING_VALUE_SINGLE_MEDIC_RESULT_SET_DATA_REFERENCE = "single-medic-result-set-data-reference";
	String CODESYSTEM_HIGHMED_DATA_SHARING_VALUE_SINGLE_MEDIC_RESULT_SET_RBF_REFERENCE = "single-medic-result-set-rbf-reference";
