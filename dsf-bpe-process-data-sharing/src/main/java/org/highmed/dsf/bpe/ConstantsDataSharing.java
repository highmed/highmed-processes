...
public interface ConstantsDataSharing
{
	...
	String BPMN_EXECUTION_VARIABLE_RBF_RESULTS = "rbfResults";
	...
	String CODESYSTEM_HIGHMED_DATA_SHARING_VALUE_SINGLE_MEDIC_RESULT_SET_RESULT_REFERENCE = "single-medic-result-set-result-reference";
