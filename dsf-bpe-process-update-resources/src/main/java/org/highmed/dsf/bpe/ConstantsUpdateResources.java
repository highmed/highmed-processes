...
{
	String PROCESS_NAME_EXECUTE_UPDATE_RESOURCES = "executeUpdateResources";
	String PROCESS_NAME_REQUEST_UPDATE_RESOURCES = "requestUpdateResources";

	String PROCESS_NAME_FULL_EXECUTE_UPDATE_RESOURCES = "highmedorg_" + PROCESS_NAME_EXECUTE_UPDATE_RESOURCES;
	String PROCESS_NAME_FULL_REQUEST_UPDATE_RESOURCES = "highmedorg_" + PROCESS_NAME_REQUEST_UPDATE_RESOURCES;
	...
	String PROFILE_HIGHMED_TASK_REQUEST_UPDATE_RESOURCES_AND_LATEST_VERSION = PROFILE_HIGHMED_TASK_REQUEST_UPDATE_RESOURCES
			+ "|" + VERSION;
	String PROFILE_HIGHMED_TASK_REQUEST_UPDATE_RESOURCES_PROCESS_URI = PROCESS_HIGHMED_URI_BASE
			+ PROCESS_NAME_REQUEST_UPDATE_RESOURCES + "/";
	...
	String PROFILE_HIGHMED_TASK_EXECUTE_UPDATE_RESOURCES_AND_LATEST_VERSION = PROFILE_HIGHMED_TASK_EXECUTE_UPDATE_RESOURCES
			+ "|" + VERSION;
